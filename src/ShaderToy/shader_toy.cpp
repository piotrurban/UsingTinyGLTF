...
int main()
{
	...
	SimpleContent distance_content = createSimpleContent("seascape");
	...
	distance_content.setUniform("iResolution", glm::vec3((float)window_width, (float)window_height, 0.0f));
